...
# MODEL ARCHITECTURE
# ============================================================================
EMBEDDING_DIM = 300      # FastText dimension (cc.en.300.bin)
...
# PATHS
# ============================================================================
# Go up two levels: pointer_generator_fasttext -> summaries -> News2Stock
...
# FASTTEXT EMBEDDINGS
# ============================================================================
FASTTEXT_MODEL_PATH = os.path.join(ROOT_DIR, 'models', 'cc.en.300.bin')
USE_FASTTEXT = True      # Initialize embeddings with FastText
